...
class PaketSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pakets = [
            ...
            // Paket baru upload
            ['jenis_layanan_id'=>1,'kode_paket'=>'UMR-JUL26-BARU',    'nama_paket'=>'Paket Umroh Juli 2026',                    'deskripsi'=>'Keberangkatan Juli 2026 (SUB→Jed). Maskapai: Lion Air.','durasi_hari'=>13,'kapasitas_maks'=>40,'harga_dasar'=>32500000,'include_detail'=>$inc,'exclude_detail'=>$exc,'flyer_url'=>'/flyer/paket-juli-baru.webp','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>1,'kode_paket'=>'UMR-AGS26-BARU',    'nama_paket'=>'Paket Umroh Agustus 2026',                 'deskripsi'=>'Keberangkatan Agustus 2026 (SUB→Jed). Maskapai: Lion Air.','durasi_hari'=>13,'kapasitas_maks'=>40,'harga_dasar'=>33000000,'include_detail'=>$inc,'exclude_detail'=>$exc,'flyer_url'=>'/flyer/paket-agustus-baru.webp','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>1,'kode_paket'=>'UMR-OKT26-BARU',    'nama_paket'=>'Paket Umroh Oktober 2026',                 'deskripsi'=>'Keberangkatan Oktober 2026 (SUB→Jed). Maskapai: Lion Air.','durasi_hari'=>13,'kapasitas_maks'=>40,'harga_dasar'=>33000000,'include_detail'=>$inc,'exclude_detail'=>$exc,'flyer_url'=>'/flyer/paket-oktober-baru.webp','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
        ];
        ...
        $harga = [
            ...
            [17,32500000,36000000,40000000,52500000],
            [18,33000000,36500000,40500000,53000000],
            [19,33000000,36500000,40500000,53000000],
        ];
