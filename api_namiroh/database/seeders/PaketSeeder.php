...
class PaketSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pakets = [
            ...
            // Layanan lain
            ['jenis_layanan_id'=>4,'kode_paket'=>'HAJI-PLUS-2026',    'nama_paket'=>'Haji Plus 2026',                            'deskripsi'=>'Daftar sekarang hanya Rp500.000. Porsi haji plus resmi Kemenag RI, fasilitas VIP.','durasi_hari'=>40,'kapasitas_maks'=>30,'harga_dasar'=>500000,'flyer_url'=>'flyer/haji-plus-2026.webp','include_detail'=>'Porsi Haji Plus Resmi, Maktab VIP, Visa Haji, Hotel Dekat Pelataran, Bimbingan Eksklusif, Asuransi','exclude_detail'=>'Biaya Pelunasan (diinformasikan kemudian), Biaya Paspor, Pengeluaran Pribadi','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>5,'kode_paket'=>'BADAL-UMROH-2026',   'nama_paket'=>'Badal Umroh',                              'deskripsi'=>'Ibadah umroh ditunaikan mutawif profesional atas nama yang telah meninggal atau tidak mampu berangkat.','durasi_hari'=>9,'kapasitas_maks'=>10,'harga_dasar'=>3000000,'flyer_url'=>'flyer/Badal-Umroh-Haji-768x960.webp','include_detail'=>'Ibadah Umroh Pengganti oleh Mutawif, Piagam Badal Umroh, Air Zamzam 500ml, Souvenir','exclude_detail'=>'-','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>6,'kode_paket'=>'BADAL-HAJI-2026',    'nama_paket'=>'Badal Haji',                               'deskripsi'=>'Ibadah haji ditunaikan mutawif senior atas nama keluarga yang telah berpulang atau tidak mampu berangkat.','durasi_hari'=>40,'kapasitas_maks'=>5,'harga_dasar'=>13500000,'flyer_url'=>'flyer/Badal-Umroh-Haji-768x960.webp','include_detail'=>'Ibadah Haji Pengganti oleh Mutawif Senior, Piagam Badal Haji, Air Zamzam 500ml, Souvenir','exclude_detail'=>'-','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>7,'kode_paket'=>'HALAL-TURKEY-2026',  'nama_paket'=>'Umroh Plus Turkey — Istanbul & Bursa',     'deskripsi'=>'12 hari, start Surabaya. Menelusuri jejak peradaban Islam di Mekkah, Madinah, Istanbul & Bursa Turki.','durasi_hari'=>12,'kapasitas_maks'=>35,'harga_dasar'=>37250000,'flyer_url'=>'flyer/umroh-plus-turkey.webp','include_detail'=>$inc.', Tiket Jeddah–Istanbul, City Tour Istanbul & Bursa, Hotel Istanbul & Bursa','exclude_detail'=>$exc.', Biaya Masuk Objek Wisata Berbayar','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            // Paket baru upload
            ['jenis_layanan_id'=>1,'kode_paket'=>'UMR-JUL26-BARU',    'nama_paket'=>'Paket Umroh New Season 1448H — Juli 2026',  'deskripsi'=>'11 program keberangkatan Juli 2026 (mulai 1 Jul). Durasi 12–30 hari, pilihan SUB→Jed & SUB→Med. Maskapai: Lion Air & Garuda Indonesia. Harga mulai Rp29.700.000.','durasi_hari'=>12,'kapasitas_maks'=>40,'harga_dasar'=>29700000,'include_detail'=>$inc.', Asuransi Perjalanan Umroh','exclude_detail'=>$exc,'flyer_url'=>'flyer/paket-juli-baru.webp','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>1,'kode_paket'=>'UMR-AGS26-BARU',    'nama_paket'=>'Paket Umroh Spesial Bulan Kemerdekaan 1448H — Agustus 2026', 'deskripsi'=>'15 program keberangkatan Agustus 2026 (mulai 1 Ags). Durasi 12–30 hari, pilihan SUB→Jed & SUB→Med. Maskapai: Lion Air & Garuda Indonesia. Harga mulai Rp30.800.000.','durasi_hari'=>12,'kapasitas_maks'=>40,'harga_dasar'=>30800000,'include_detail'=>$inc.', Asuransi Perjalanan Umroh','exclude_detail'=>$exc,'flyer_url'=>'flyer/paket-agustus-baru.webp','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>1,'kode_paket'=>'UMR-OKT26-BARU',    'nama_paket'=>'Paket Umroh Oktoberkah 1448H — Oktober 2026', 'deskripsi'=>'8 program keberangkatan Oktober 2026. Durasi 12–30 hari, pilihan SUB→Jed & SUB→Med. Maskapai: Lion Air & Garuda Indonesia. Harga mulai Rp31.800.000.','durasi_hari'=>12,'kapasitas_maks'=>40,'harga_dasar'=>31800000,'include_detail'=>$inc.', Asuransi Perjalanan Umroh','exclude_detail'=>$exc,'flyer_url'=>'flyer/paket-oktober-baru.webp','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>1,'kode_paket'=>'UMR-SEP26-BARU',    'nama_paket'=>'Paket Umroh September 1448H — September 2026', 'deskripsi'=>'12 program keberangkatan September 2026 (mulai 1 Sep). Durasi 12–30 hari. Maskapai: Lion Air & Garuda Indonesia. Harga mulai Rp30.300.000.','durasi_hari'=>12,'kapasitas_maks'=>40,'harga_dasar'=>30300000,'include_detail'=>$inc.', Asuransi Perjalanan Umroh','exclude_detail'=>$exc,'flyer_url'=>'flyer/paket-september-baru.webp','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>1,'kode_paket'=>'UMR-NOV26-BARU',    'nama_paket'=>'Paket Umroh November Hijrah 1448H — November 2026', 'deskripsi'=>'7 program keberangkatan November 2026 (mulai 2 Nov). Durasi 12–30 hari. Maskapai: Garuda Indonesia & Lion Air. Harga mulai Rp30.650.000.','durasi_hari'=>12,'kapasitas_maks'=>40,'harga_dasar'=>30650000,'include_detail'=>$inc.', Asuransi Perjalanan Umroh','exclude_detail'=>$exc,'flyer_url'=>'flyer/paket-november-baru.webp','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>1,'kode_paket'=>'UMR-DES26-BARU',    'nama_paket'=>'Paket Umroh Desember 1448H — Akhir Tahun 2026',    'deskripsi'=>'4 program keberangkatan Desember 2026 (mulai 9 Des). Durasi 12–16 hari. Maskapai: Garuda Indonesia & Lion Air. Harga mulai Rp31.300.000.','durasi_hari'=>12,'kapasitas_maks'=>40,'harga_dasar'=>31300000,'include_detail'=>$inc.', Asuransi Perjalanan Umroh','exclude_detail'=>$exc,'flyer_url'=>'flyer/paket-desember-baru.webp','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
        ];
        ...
        $harga = [
            ...
            [17,29700000,33200000,37200000,49700000],
            [18,30800000,34300000,38300000,50800000],
            [19,31800000,35300000,39300000,51800000],
            [20,30300000,33800000,37800000,50300000],
            [21,30650000,34150000,38150000,50650000],
            [22,31300000,34800000,38800000,51300000],
        ];
