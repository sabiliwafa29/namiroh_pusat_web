...
class PaketSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pakets = [
            ...
            ['jenis_layanan_id'=>5,'kode_paket'=>'BADAL-UMROH-2026',   'nama_paket'=>'Badal Umroh',                              'deskripsi'=>'Ibadah umroh ditunaikan mutawif profesional atas nama yang telah meninggal atau tidak mampu berangkat.','durasi_hari'=>9,'kapasitas_maks'=>10,'harga_dasar'=>3000000,'flyer_url'=>'/flyer/Badal-Umroh-Haji-768x960.jpg','include_detail'=>'Ibadah Umroh Pengganti oleh Mutawif, Piagam Badal Umroh, Air Zamzam 500ml, Souvenir','exclude_detail'=>'-','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
            ['jenis_layanan_id'=>6,'kode_paket'=>'BADAL-HAJI-2026',    'nama_paket'=>'Badal Haji',                               'deskripsi'=>'Ibadah haji ditunaikan mutawif senior atas nama keluarga yang telah berpulang atau tidak mampu berangkat.','durasi_hari'=>40,'kapasitas_maks'=>5,'harga_dasar'=>13500000,'flyer_url'=>'/flyer/Badal-Umroh-Haji-768x960.jpg','include_detail'=>'Ibadah Haji Pengganti oleh Mutawif Senior, Piagam Badal Haji, Air Zamzam 500ml, Souvenir','exclude_detail'=>'-','is_published'=>1,'is_active'=>1,'created_at'=>now(),'updated_at'=>now()],
