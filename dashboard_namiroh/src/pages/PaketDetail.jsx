    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-gradient-to-br from-green-800 to-green-900 text-white py-10 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold mb-2">{paket.nama_paket}</h1>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {paket.include_detail && (
                <div className="bg-white rounded-xl p-5 shadow-sm">
                  <h2 className="font-semibold text-green-800 mb-3 flex items-center gap-2">✅ Sudah Termasuk</h2>
                  <p className="text-sm text-gray-600 leading-relaxed whitespace-pre-line">{paket.include_detail}</p>
                </div>
              )}
              {paket.exclude_detail && (
                <div className="bg-white rounded-xl p-5 shadow-sm">
                  <h2 className="font-semibold text-red-700 mb-3 flex items-center gap-2">❌ Tidak Termasuk</h2>
            ...
            {paket.itinerary?.length > 0 && (
              <div className="bg-white rounded-xl p-5 shadow-sm">
                <h2 className="font-semibold text-green-800 mb-4">📅 Program Perjalanan</h2>
            ...
            {paket.jadwal?.length > 0 && (
              <div className="bg-white rounded-xl p-5 shadow-sm">
                <h2 className="font-semibold text-green-800 mb-4">✈️ Jadwal Keberangkatan</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm sticky top-24">
              <h2 className="font-semibold text-gray-800 mb-3">Harga Per Orang</h2>
