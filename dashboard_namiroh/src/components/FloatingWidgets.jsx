  ...
  return (
    <>
      ...
      {!bannerDismissed && promo && (
        <div className={`fixed bottom-4 left-3 z-50 w-44 sm:w-60 transition-all duration-500 ${
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-orange-200 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-green-800 to-green-700 px-3 py-1.5 flex items-center justify-between">
              <span className="text-white text-[10px] sm:text-xs font-bold tracking-wide uppercase">🔥 Promo Terbaru</span>
            ...
            <div className="p-2 sm:p-3 flex gap-2 sm:gap-3 items-center">
              {promo.flyer_url ? (
                ...
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0 text-lg sm:text-xl">
                  🕌
                </div>
              )}
      ...
      >
        ...
        <div className="relative flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white pl-2 pr-2.5 py-2 sm:pl-2.5 sm:pr-3 sm:py-2.5 rounded-full shadow-2xl transition-all duration-300 group-hover:shadow-green-400/40">
          {/* WA icon */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 fill-white">
