  ...
  return (
    <>
      ...
      {!bannerDismissed && promo && (
        <div className={`fixed bottom-4 left-3 z-50 w-56 sm:w-72 transition-all duration-500 ${
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-orange-200 overflow-hidden">
            ...
            <div className="p-2 sm:p-3 flex gap-2 sm:gap-3 items-center">
              {promo.flyer_url ? (
                ...
                <div className="w-12 h-12 sm:w-16 sm:h-16 bg-green-100 rounded-xl flex items-center justify-center flex-shrink-0 text-xl sm:text-2xl">
                  🕌
                </div>
              )}
      ...
      >
        ...
        <div className="relative flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white pl-2.5 pr-3 py-2.5 sm:pl-3 sm:pr-4 sm:py-3 rounded-full shadow-2xl transition-all duration-300 group-hover:shadow-green-400/40">
          {/* WA icon */}
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 fill-white">
