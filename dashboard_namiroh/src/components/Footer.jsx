        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-base text-green-200">
              <li><Link to="/paket?jenis_layanan_id=1" className="hover:text-white transition">Paket Umroh Reguler</Link></li>
              <li><Link to="/paket?jenis_layanan_id=2" className="hover:text-white transition">Paket Umroh VIP</Link></li>
              <li><Link to="/paket?jenis_layanan_id=4" className="hover:text-white transition">Haji Plus</Link></li>
              <li><Link to="/paket?jenis_layanan_id=5" className="hover:text-white transition">Badal Umroh &amp; Haji</Link></li>
              <li><Link to="/paket?jenis_layanan_id=7" className="hover:text-white transition">Halal Tour</Link></li>
            </ul>
          </div>
